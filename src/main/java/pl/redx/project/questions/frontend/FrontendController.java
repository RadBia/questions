package pl.redx.project.questions.frontend;
...
import pl.redx.project.questions.services.OngoingGameService;
...
public class FrontendController {
    ...
    public String select(Model model) {
        ...
        model.addAttribute("categories", questionsDataService.getCategories());
        return "select";
    }
